...
1. Find the **Header Search Paths** setting. Double click and add a new entry. The path is <path to your RestKit checkout>/Build. For example, if you checked the submodule out to the 'Libraries' subdirectory of your project, your header path would be 'Libraries/RestKit/Build'.
