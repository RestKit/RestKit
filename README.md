...
- Interested in a further example tutorial? [RKJets](https://github.com/telegraphy-interactive/RKJets) from [TelegraphyInteractive](http://www.telegraphyinteractive.com) provides a tutorial with full Create, Read, Update, and Delete function against a [json-server](https://github.com/typicode/json-server) on localhost.
