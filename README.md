...
1. Find the **Header Search Paths** setting. Double click and add a new entry. Add a search path to the "RestKit/Build" directory you have added to your project. **DO NOT** check the `Recursive` checkbox.
