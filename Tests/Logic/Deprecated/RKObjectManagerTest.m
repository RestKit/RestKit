...
- (void)setUp
{
    ...
    [self.objectManager addResponseDescriptorsFromArray:@[
     [RKResponseDescriptor responseDescriptorWithMapping:humanMapping method:RKHTTPMethodAny pathPattern:nil keyPath:@"human" statusCodes:RKStatusCodeIndexSetForClass(RKStatusCodeClassSuccessful)],
     [RKResponseDescriptor responseDescriptorWithMapping:humanMapping method:RKHTTPMethodAny pathPattern:nil keyPath:@"humans" statusCodes:RKStatusCodeIndexSetForClass(RKStatusCodeClassSuccessful)]
     ]];
    ...
    [self.objectManager addRequestDescriptor:[RKRequestDescriptor requestDescriptorWithMapping:humanSerialization objectClass:[RKHuman class] rootKeyPath:@"human" method:RKHTTPMethodAny]];

    self.humanPOSTRoute = [RKRoute routeWithClass:[RKHuman class] URITemplateString:@"/humans" method:RKHTTPMethodPOST];
    self.humanGETRoute = [RKRoute routeWithClass:[RKHuman class] URITemplateString:@"/humans/:railsID" method:RKHTTPMethodGET];
    self.humanDELETERoute = [RKRoute routeWithClass:[RKHuman class] URITemplateString:@"/humans/:railsID" method:RKHTTPMethodDELETE];
    self.humanCatsRoute = [RKRoute routeWithRelationshipName:@"cats" objectClass:[RKHuman class] URITemplateString:@"/humans/:railsID/cats" method:RKHTTPMethodGET];
    self.humansCollectionRoute = [RKRoute routeWithName:@"humans" URITemplateString:@"/humans" method:RKHTTPMethodGET];
...
- (void)testShouldUpdateACoreDataBackedTargetObject
{
    ...
    RKManagedObjectRequestOperation *operation = [_objectManager appropriateObjectRequestOperationWithObject:temporaryHuman method:RKHTTPMethodPOST path:nil parameters:nil];
    [operation start];
...
- (void)testShouldNotPersistTemporaryEntityToPersistentStoreOnError
{
    ...
    RKManagedObjectRequestOperation *operation = [_objectManager appropriateObjectRequestOperationWithObject:temporaryHuman method:RKHTTPMethodPOST path:@"/humans/fail" parameters:nil];
    [operation start];
    [operation waitUntilFinished];
...
- (void)testThatFailedObjectRequestOperationDoesNotSaveObjectToPersistentStore
{
    ...
    RKManagedObjectRequestOperation *operation = [self.objectManager appropriateObjectRequestOperationWithObject:temporaryHuman method:RKHTTPMethodPOST path:@"/humans/fail" parameters:nil];
    [operation start];
    [operation waitUntilFinished];
...
- (void)testShouldDeleteACoreDataBackedTargetObjectOnSuccessfulDeleteReturning200
{
    ...
    RKManagedObjectRequestOperation *operation = [self.objectManager appropriateObjectRequestOperationWithObject:temporaryHuman method:RKHTTPMethodDELETE path:nil parameters:nil];
    [operation start];
    [operation waitUntilFinished];
...
- (void)testCancellationByExactMethodAndPath
{
    ...
    [_objectManager cancelAllObjectRequestOperationsWithMethod:RKHTTPMethodGET matchingPathPattern:@"/object_manager/cancel"];
...
- (void)testCancellationByPathMatch
{
    ...
    RKObjectRequestOperation *operation = [[RKObjectRequestOperation alloc] initWithRequest:request responseDescriptors:self.objectManager.responseDescriptors];
    [_objectManager enqueueObjectRequestOperation:operation];
    [_objectManager cancelAllObjectRequestOperationsWithMethod:RKHTTPMethodGET matchingPathPattern:@"/object_manager/:objectID/cancel"];
    expect([operation isCancelled]).to.equal(YES);
}
...
- (void)testCancellationFailsForMismatchedMethod
{
    ...
    RKObjectRequestOperation *operation = [[RKObjectRequestOperation alloc] initWithRequest:request responseDescriptors:self.objectManager.responseDescriptors];
    [_objectManager enqueueObjectRequestOperation:operation];
    [_objectManager cancelAllObjectRequestOperationsWithMethod:RKHTTPMethodPOST matchingPathPattern:@"/object_manager/cancel"];
...
- (void)testCancellationFailsForMismatchedPath
{
    ...
    RKObjectRequestOperation *operation = [[RKObjectRequestOperation alloc] initWithRequest:request responseDescriptors:self.objectManager.responseDescriptors];
    [_objectManager enqueueObjectRequestOperation:operation];
    [_objectManager cancelAllObjectRequestOperationsWithMethod:RKHTTPMethodGET matchingPathPattern:@"/wrong"];
    expect([operation isCancelled]).to.equal(NO);
}
...
- (void)testCancellationByPathMatchForBaseURLWithPath
{
    ...
    RKObjectRequestOperation *operation = [[RKObjectRequestOperation alloc] initWithRequest:request responseDescriptors:self.objectManager.responseDescriptors];
    [_objectManager enqueueObjectRequestOperation:operation];
    [_objectManager cancelAllObjectRequestOperationsWithMethod:RKHTTPMethodGET matchingPathPattern:@":objectID/cancel"];
    expect([operation isCancelled]).to.equal(YES);
}
...
- (void)testCancellationOfMultipartRequestByPath
{
    ...
    NSMutableURLRequest *request = [self.objectManager multipartFormRequestWithObject:testUser method:RKHTTPMethodPOST path:@"path" parameters:nil constructingBodyWithBlock:^(id<AFMultipartFormData> formData) {
        [formData appendPartWithFormData:[@"testing" dataUsingEncoding:NSUTF8StringEncoding] name:@"part"];
    }];
    RKObjectRequestOperation *operation = [[RKObjectRequestOperation alloc] initWithRequest:request responseDescriptors:self.objectManager.responseDescriptors];
    [_objectManager enqueueObjectRequestOperation:operation];
    [_objectManager cancelAllObjectRequestOperationsWithMethod:RKHTTPMethodPOST matchingPathPattern:@"path"];
    expect([operation isCancelled]).to.equal(YES);
}
...
- (void)testEnqueuedObjectRequestOperationByExactMethodAndPath
{
    ...
    RKObjectRequestOperation *operation = [[RKObjectRequestOperation alloc] initWithRequest:request responseDescriptors:self.objectManager.responseDescriptors];
    [_objectManager enqueueObjectRequestOperation:operation];
    expect([[_objectManager enqueuedObjectRequestOperationsWithMethod:RKHTTPMethodGET matchingPathPattern:@"/object_manager/cancel"] count]).to.equal(1);
}
...
- (void)testEnqueuedObjectRequestOperationByMultipleExactMethodAndPath
{
    ...
    expect([[_objectManager enqueuedObjectRequestOperationsWithMethod:RKHTTPMethodGET matchingPathPattern:@"/object_manager/cancel"] count]).to.equal(3);
}
...
- (void)testEnqueuedObjectRequestOperationByPathMatch
{
    ...
    RKObjectRequestOperation *operation = [[RKObjectRequestOperation alloc] initWithRequest:request responseDescriptors:self.objectManager.responseDescriptors];
    [_objectManager enqueueObjectRequestOperation:operation];
    expect([[_objectManager enqueuedObjectRequestOperationsWithMethod:RKHTTPMethodGET matchingPathPattern:@"/object_manager/:objectID/cancel"] count]).to.equal(1);
}
...
- (void)testEnqueuedObjectRequestOperationFailsForMismatchedMethod
{
    ...
    RKObjectRequestOperation *operation = [[RKObjectRequestOperation alloc] initWithRequest:request responseDescriptors:self.objectManager.responseDescriptors];
    [_objectManager enqueueObjectRequestOperation:operation];
    expect([[_objectManager enqueuedObjectRequestOperationsWithMethod:RKHTTPMethodGET matchingPathPattern:@"/wrong"] count]).to.equal(0);
}
...
- (void)testEnqueuedObjectRequestOperationByPathMatchForBaseURLWithPath
{
    ...
    RKObjectRequestOperation *operation = [[RKObjectRequestOperation alloc] initWithRequest:request responseDescriptors:self.objectManager.responseDescriptors];
    [_objectManager enqueueObjectRequestOperation:operation];
    expect([[_objectManager enqueuedObjectRequestOperationsWithMethod:RKHTTPMethodGET matchingPathPattern:@":objectID/cancel"] count]).to.equal(1);
}
...
- (void)testEnqueuedObjectRequestOperationByMultipleBitmaskMethodAndPath
{
    ...
    [_objectManager enqueueObjectRequestOperation:secondOperation];
    [_objectManager enqueueObjectRequestOperation:thirdOperation];
    NSArray *operations = [_objectManager enqueuedObjectRequestOperationsWithMethod:RKHTTPMethodGET | RKHTTPMethodPOST matchingPathPattern:@"/object_manager/cancel"];
...
- (void)testShouldProperlyFireABatchOfOperations
{
    ...
    RKManagedObjectRequestOperation *successfulGETOperation = [_objectManager appropriateObjectRequestOperationWithObject:temporaryHuman method:RKHTTPMethodGET path:nil parameters:nil];
    RKManagedObjectRequestOperation *successfulPOSTOperation = [_objectManager appropriateObjectRequestOperationWithObject:temporaryHuman method:RKHTTPMethodPOST path:nil parameters:nil];
    RKManagedObjectRequestOperation *failedPOSTOperation = [_objectManager appropriateObjectRequestOperationWithObject:temporaryHuman method:RKHTTPMethodPOST path:@"/humans/fail" parameters:nil];
...
- (void)testThatObjectParametersAreNotSentDuringGetObject
{
    ...
    temporaryHuman.name = @"My Name";
    temporaryHuman.railsID = @204;
    RKManagedObjectRequestOperation *operation = [_objectManager appropriateObjectRequestOperationWithObject:temporaryHuman method:RKHTTPMethodGET path:nil parameters:@{@"this": @"that"}];
...
- (void)testThatObjectParametersAreNotSentDuringDeleteObject
{
    ...
    temporaryHuman.name = @"My Name";
    temporaryHuman.railsID = @204;
    RKManagedObjectRequestOperation *operation = [_objectManager appropriateObjectRequestOperationWithObject:temporaryHuman method:RKHTTPMethodDELETE path:nil parameters:@{@"this": @"that"}];
    expect([operation.HTTPRequestOperation.request.URL absoluteString]).to.equal(@"http://127.0.0.1:4567/humans/204?this=that");
}
...
{
    RKHuman *temporaryHuman = [RKTestFactory insertManagedObjectForEntityForName:@"Human" inManagedObjectContext:nil withProperties:nil];
    NSURLRequest *request = [_objectManager requestWithObject:temporaryHuman method:RKHTTPMethodPATCH path:@"/the/path" parameters:@{@"key": @"value"}];
...
- (void)testAFHTTPClientCanModifyRequestsBuiltByObjectManager
{
    ...
    RKHuman *temporaryHuman = [RKTestFactory insertManagedObjectForEntityForName:@"Human" inManagedObjectContext:nil withProperties:nil];
    NSURLRequest *request = [manager requestWithObject:temporaryHuman method:RKHTTPMethodPATCH path:@"/the/path" parameters:@{@"key": @"value"}];
...
- (void)testThatAttemptingToAddARequestDescriptorThatOverlapsAnExistingEntryGeneratesAnError
{
    ...
    RKRequestDescriptor *requestDesriptor1 = [RKRequestDescriptor requestDescriptorWithMapping:mapping objectClass:[RKCat class] rootKeyPath:nil method:RKHTTPMethodAny];
    RKRequestDescriptor *requestDesriptor2 = [RKRequestDescriptor requestDescriptorWithMapping:mapping objectClass:[RKCat class] rootKeyPath:@"cat" method:RKHTTPMethodAny];
...
- (void)testThatRegisteringARequestDescriptorForASubclassSecondWillMatchAppropriately
{
    ...
    RKRequestDescriptor *requestDesriptor1 = [RKRequestDescriptor requestDescriptorWithMapping:mapping1 objectClass:[RKObjectMapperTestModel class] rootKeyPath:nil method:RKHTTPMethodAny];
    RKRequestDescriptor *requestDesriptor2 = [RKRequestDescriptor requestDescriptorWithMapping:mapping2 objectClass:[RKSubclassedTestModel class] rootKeyPath:@"subclassed" method:RKHTTPMethodAny];
    RKObjectManager *objectManager = [RKTestFactory objectManager];
    ...
    model.name = @"Blake";
    model.age = @30;
    NSURLRequest *request = [objectManager requestWithObject:model method:RKHTTPMethodPOST path:@"/path" parameters:nil];
...
- (void)testThatResponseDescriptorWithUnmanagedMappingTriggersCreationOfObjectRequestOperation
{
    ...
    RKResponseDescriptor *responseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:vanillaMapping method:RKHTTPMethodAny pathPattern:nil keyPath:nil statusCodes:nil];
    RKObjectManager *manager = [RKObjectManager managerWithBaseURL:[NSURL URLWithString:@"http://restkit.org"]];
    manager.managedObjectStore = [RKTestFactory managedObjectStore];
    [manager addResponseDescriptor:responseDescriptor];
    RKObjectRequestOperation *objectRequestOperation = [manager appropriateObjectRequestOperationWithObject:nil method:RKHTTPMethodGET path:@"/something" parameters:nil];
...
- (void)testThatResponseDescriptorWithDynamicMappingContainingEntityMappingsTriggersCreationOfManagedObjectRequestOperation
{
    ...
    RKResponseDescriptor *responseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:dynamicMapping method:RKHTTPMethodAny pathPattern:nil keyPath:nil statusCodes:nil];
    RKObjectManager *manager = [RKObjectManager managerWithBaseURL:[NSURL URLWithString:@"http://restkit.org"]];
    manager.managedObjectStore = [RKTestFactory managedObjectStore];
    [manager addResponseDescriptor:responseDescriptor];
    RKObjectRequestOperation *objectRequestOperation = [manager appropriateObjectRequestOperationWithObject:nil method:RKHTTPMethodGET path:@"/something" parameters:nil];
...
- (void)testThatResponseDescriptorWithUnmanagedMappingContainingRelationshipMappingWithEntityMappingsTriggersCreationOfManagedObjectRequestOperation
{
    ...
    RKResponseDescriptor *responseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:objectMapping method:RKHTTPMethodAny pathPattern:nil keyPath:nil statusCodes:nil];
    RKObjectManager *manager = [RKObjectManager managerWithBaseURL:[NSURL URLWithString:@"http://restkit.org"]];
    manager.managedObjectStore = [RKTestFactory managedObjectStore];
    [manager addResponseDescriptor:responseDescriptor];
    RKObjectRequestOperation *objectRequestOperation = [manager appropriateObjectRequestOperationWithObject:nil method:RKHTTPMethodGET path:@"/something" parameters:nil];
...
- (void)testThatResponseDescriptorWithUnmanagedMappingContainingRelationshipMappingWithEntityMappingsDeepWithinObjectGraphTriggersCreationOfManagedObjectRequestOperation
{
    ...
    RKResponseDescriptor *responseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:objectMapping2 method:RKHTTPMethodAny pathPattern:nil keyPath:nil statusCodes:nil];
    RKObjectManager *manager = [RKObjectManager managerWithBaseURL:[NSURL URLWithString:@"http://restkit.org"]];
    manager.managedObjectStore = [RKTestFactory managedObjectStore];
    [manager addResponseDescriptor:responseDescriptor];
    RKObjectRequestOperation *objectRequestOperation = [manager appropriateObjectRequestOperationWithObject:nil method:RKHTTPMethodGET path:@"/something" parameters:nil];
...
- (void)testPostingOneObjectAndGettingResponseMatchingAnotherClass
{
    ...
    RKResponseDescriptor *metaResponseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:metaMapping method:RKHTTPMethodAny pathPattern:nil keyPath:@"meta" statusCodes:RKStatusCodeIndexSetForClass(RKStatusCodeClassSuccessful)];
    
    [manager addResponseDescriptorsFromArray:@[ metaResponseDescriptor ]];
    RKTestUser *user = [RKTestUser new];
    RKObjectRequestOperation *requestOperation = [manager appropriateObjectRequestOperationWithObject:user method:RKHTTPMethodPOST path:@"/ComplexUser" parameters:nil];
...
- (void)testPostingOneObjectAndGettingResponseMatchingMultipleDescriptors
{
    ...
    RKObjectMapping *userMapping = [RKObjectMapping mappingForClass:[RKTestUser class]];
    [userMapping addAttributeMappingsFromDictionary:@{ @"fullname": @"name" }];
    RKResponseDescriptor *userResponseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:userMapping method:RKHTTPMethodAny pathPattern:nil keyPath:@"data.STUser" statusCodes:RKStatusCodeIndexSetForClass(RKStatusCodeClassSuccessful)];
    RKObjectMapping *metaMapping = [RKObjectMapping mappingForClass:[NSMutableDictionary class]];
    [metaMapping addAttributeMappingsFromArray:@[ @"status", @"version" ]];    
    RKResponseDescriptor *metaResponseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:metaMapping method:RKHTTPMethodAny pathPattern:nil keyPath:@"meta" statusCodes:RKStatusCodeIndexSetForClass(RKStatusCodeClassSuccessful)];
...
- (void)testThatAppropriateObjectRequestOperationReturnsManagedObjectRequestOperationForManagedObjectWithNoResponseDescriptors
{
    ...
    RKObjectRequestOperation *objectRequestOperation = [manager appropriateObjectRequestOperationWithObject:managedObject method:RKHTTPMethodPOST path:@"/something" parameters:nil];
    expect(objectRequestOperation).to.beInstanceOf([RKManagedObjectRequestOperation class]);
}
...
- (void)testCreatingAnObjectRequestWithoutARequestDescriptorButWithParametersSetsTheRequestBody
{
    ...
    NSURLRequest *request = [objectManager requestWithObject:user method:RKHTTPMethodPOST path:@"/path" parameters:@{ @"this": @"that" }];
...
- (void)testPostingAnArrayOfObjectsWhereNoneHaveARootKeyPath
{
    ...
    RKRequestDescriptor *firstRequestDescriptor = [RKRequestDescriptor requestDescriptorWithMapping:firstRequestMapping objectClass:[RKTestUser class] rootKeyPath:nil method:RKHTTPMethodAny];
    RKRequestDescriptor *secondRequestDescriptor = [RKRequestDescriptor requestDescriptorWithMapping:secondRequestMapping objectClass:[RKTestAddress class] rootKeyPath:nil method:RKHTTPMethodAny];
    ...
    NSURLRequest *request = [objectManager requestWithObject:arrayOfObjects method:RKHTTPMethodPOST path:@"/path" parameters:nil];
...
- (void)testPostingAnArrayOfObjectsWhereAllObjectsHaveAnOverlappingRootKeyPath
{
    ...
    RKRequestDescriptor *firstRequestDescriptor = [RKRequestDescriptor requestDescriptorWithMapping:firstRequestMapping objectClass:[RKTestUser class] rootKeyPath:@"whatever" method:RKHTTPMethodAny];
    RKRequestDescriptor *secondRequestDescriptor = [RKRequestDescriptor requestDescriptorWithMapping:secondRequestMapping objectClass:[RKTestAddress class] rootKeyPath:@"whatever" method:RKHTTPMethodAny];
...
- (void)testPostingAnArrayOfObjectsWithMixedRootKeyPath
{
    ...
    RKRequestDescriptor *firstRequestDescriptor = [RKRequestDescriptor requestDescriptorWithMapping:firstRequestMapping objectClass:[RKTestUser class] rootKeyPath:@"this" method:RKHTTPMethodAny];
    RKRequestDescriptor *secondRequestDescriptor = [RKRequestDescriptor requestDescriptorWithMapping:secondRequestMapping objectClass:[RKTestAddress class] rootKeyPath:@"that" method:RKHTTPMethodAny];
...
- (void)testPostingAnArrayOfObjectsWithNonNilRootKeyPathAndExtraParameters
{
    ...
    NSArray *arrayOfObjects = @[ user, address ];
    NSURLRequest *request = [objectManager requestWithObject:arrayOfObjects method:RKHTTPMethodPOST path:@"/path" parameters:@{ @"extra": @"info" }];
    NSArray *array = [NSJSONSerialization JSONObjectWithData:request.HTTPBody options:0 error:nil];
...
- (void)testPostingNilObjectWithExtraParameters
{
    ...
    NSURLRequest *request = [objectManager requestWithObject:nil method:RKHTTPMethodPOST path:@"/path" parameters:parameters];
    NSArray *array = [NSJSONSerialization JSONObjectWithData:request.HTTPBody options:0 error:nil];
...
- (void)testAttemptingToPostAnArrayOfObjectsWithMixtureOfNilAndNonNilRootKeyPathsRaisesError
{
    ...
    NSException *caughtException = nil;
    @try {
        NSURLRequest __unused *request = [objectManager requestWithObject:arrayOfObjects method:RKHTTPMethodPOST path:@"/path" parameters:@{ @"name": @"Foo" }];
    }
    @catch (NSException *exception) {
        caughtException = exception;
...
- (void)testThatAttemptingToPostObjectsWithAMixtureOfNilAndNonNilRootKeyPathsRaisesError
{
    ...
    RKRequestDescriptor *firstRequestDescriptor = [RKRequestDescriptor requestDescriptorWithMapping:firstRequestMapping objectClass:[RKTestUser class] rootKeyPath:@"bang" method:RKHTTPMethodAny];
    RKRequestDescriptor *secondRequestDescriptor = [RKRequestDescriptor requestDescriptorWithMapping:secondRequestMapping objectClass:[RKTestAddress class] rootKeyPath:nil method:RKHTTPMethodAny];
    ...
    NSException *caughtException = nil;
    @try {
        NSURLRequest __unused *request = [objectManager requestWithObject:arrayOfObjects method:RKHTTPMethodPOST path:@"/path" parameters:nil];
    }
    @catch (NSException *exception) {
        caughtException = exception;
        expect([exception name]).to.equal(NSInvalidArgumentException);
...
- (void)testThatPostingUnsavedObjectWithUnsavedChildrenDoesNotCrash
{
    ...
    RKResponseDescriptor *responseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:postMapping method:RKHTTPMethodAny pathPattern:nil keyPath:@"post" statusCodes:[NSIndexSet indexSetWithIndex:200]];
    ...
    RKRequestDescriptor *requestDescriptor = [RKRequestDescriptor requestDescriptorWithMapping:postRequestMapping objectClass:[NSManagedObject class] rootKeyPath:nil method:RKHTTPMethodAny];
    ...
    RKManagedObjectRequestOperation *operation = [objectManager appropriateObjectRequestOperationWithObject:post method:RKHTTPMethodPOST path:@"/posts.json" parameters:nil];
...
- (void)testPathMatchingForMultipartRequest
{
    ...
    NSMutableURLRequest *request = [objectManager multipartFormRequestWithObject:nil method:RKHTTPMethodPOST path:path parameters:nil constructingBodyWithBlock:^(id<AFMultipartFormData> formData) {
    ...
    [mapping addAttributeMappingsFromArray:@[ @"name" ]];
    RKResponseDescriptor *responseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:mapping method:RKHTTPMethodAny pathPattern:path keyPath:nil statusCodes:RKStatusCodeIndexSetForClass(RKStatusCodeClassSuccessful)];
    [objectManager addResponseDescriptor:responseDescriptor];
...
- (void)testPostingTemporaryObjectThatDoesNotExistInCacheDoesNotCreateDuplicatesWithFetchRequestCache
{
    ...
    objectManager.managedObjectStore = managedObjectStore;
    [objectManager addResponseDescriptor:[RKResponseDescriptor responseDescriptorWithMapping:entityMapping method:RKHTTPMethodAny pathPattern:@"/humans" keyPath:@"human" statusCodes:[NSIndexSet indexSetWithIndex:201]]];
...
- (void)testMappingErrorsFromFiveHundredStatusCodeRange
{
    ...
    [objectManager addResponseDescriptor:[RKResponseDescriptor responseDescriptorWithMapping:errorResponseMapping method:RKHTTPMethodAny pathPattern:nil keyPath:@"errors" statusCodes:statusCodes]];
...
- (void)testConnectingARelationshipToAnObjectUsingRoutingMetadata
{
    ...
    RKObjectManager *objectManager = [RKTestFactory objectManager];
    RKResponseDescriptor *responseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:tagMapping method:RKHTTPMethodAny pathPattern:@"/posts/:postID/tags" keyPath:nil statusCodes:[NSIndexSet indexSetWithIndex:200]];
    [objectManager addResponseDescriptor:responseDescriptor];
    [objectManager.router.routeSet addRoute:[RKRoute routeWithRelationshipName:@"tags" objectClass:[RKPost class] URITemplateString:@"/posts/:postID/tags" method:RKHTTPMethodGET]];
    __block RKMappingResult *mappingResult = nil;
...
- (void)testMappingMetadataParameterForNamedRoute
{
    ...
    [objectManager.router.routeSet addRoute:[RKRoute routeWithName:@"load_human" URITemplateString:@"/JSON/humans/:userID\\.json" method:RKHTTPMethodGET]];
    RKResponseDescriptor *responseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:userMapping method:RKHTTPMethodAny pathPattern:@"/JSON/humans/:userID\\.json" keyPath:@"human" statusCodes:[NSIndexSet indexSetWithIndex:200]];
    [objectManager addResponseDescriptor:responseDescriptor];
...
- (void)testRoutingMetadataWithAppropriateObjectRequestOperation
{
    ...
    RKManagedObjectRequestOperation *operation = [_objectManager appropriateObjectRequestOperationWithObject:temporaryHuman method:RKHTTPMethodDELETE path:nil parameters:nil];
...
- (void)testThatNoCrashOccursWhenLoadingNamedRouteWithNilObject
{
    RKObjectManager *objectManager = [RKObjectManager managerWithBaseURL:[RKTestFactory baseURL]];
    RKObjectMapping *userMapping = [RKObjectMapping mappingForClass:[RKTestUser class]];
    [objectManager.router.routeSet addRoute:[RKRoute routeWithName:@"named_route" URITemplateString:@"/JSON/humans/1.json" method:RKHTTPMethodGET]];
    RKResponseDescriptor *responseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:userMapping method:RKHTTPMethodAny pathPattern:nil keyPath:@"human" statusCodes:[NSIndexSet indexSetWithIndex:200]];
    [objectManager addResponseDescriptor:responseDescriptor];
...
- (void)testUseOfMetadataMappingAsIdentificationAttribute
{
    ...
    [objectManager.router.routeSet addRoute:[RKRoute routeWithName:@"load_human" URITemplateString:@"/JSON/humans/:railsID\\.json" method:RKHTTPMethodGET]];
    RKResponseDescriptor *responseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:humanMapping method:RKHTTPMethodAny pathPattern:@"/JSON/humans/:railsID\\.json" keyPath:@"human" statusCodes:[NSIndexSet indexSetWithIndex:200]];
    [objectManager addResponseDescriptor:responseDescriptor];
...
- (void)testThatPostingAnArrayOfObjectsThatWereManuallyCreatedDoesNotResultInTheCreationOfDuplicatedObjects
{
    ...
    tagMapping.identificationAttributes = @[ @"name" ];
    [tagMapping addAttributeMappingsFromArray:@[ @"name" ]];
    RKResponseDescriptor *responseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:tagMapping method:RKHTTPMethodAny pathPattern:nil keyPath:nil statusCodes:nil];
    [objectManager addResponseDescriptor:responseDescriptor];
    RKObjectMapping *requestMapping = [RKObjectMapping requestMapping];
    [requestMapping addAttributeMappingsFromArray:@[ @"name" ]];
    RKRequestDescriptor *requestDescriptor = [RKRequestDescriptor requestDescriptorWithMapping:requestMapping objectClass:[NSManagedObject class] rootKeyPath:nil method:RKHTTPMethodAny];
    [objectManager addRequestDescriptor:requestDescriptor];
...
- (void)testShouldPropagateDeletionsUpToPersistentStore
{
    ...
    RKManagedObjectRequestOperation *operation = [self.objectManager appropriateObjectRequestOperationWithObject:persistedHuman method:RKHTTPMethodDELETE path:nil parameters:nil];
...
- (void)testPostingAnObjectAndGettingBackOtherObjectsCanConnectRelationsById
{
    ...
    RKObjectManager *objectManager = [RKObjectManager managerWithBaseURL:[RKTestFactory baseURL]];
    objectManager.managedObjectStore = managedObjectStore;
    [objectManager addResponseDescriptor:[RKResponseDescriptor responseDescriptorWithMapping:humanEntityMapping method:RKHTTPMethodAny pathPattern:@"/humans/and_cats" keyPath:@"human" statusCodes:[NSIndexSet indexSetWithIndex:201]]];
    [objectManager addResponseDescriptor:[RKResponseDescriptor responseDescriptorWithMapping:catEntityMapping method:RKHTTPMethodAny pathPattern:@"/humans/and_cats" keyPath:@"cats" statusCodes:[NSIndexSet indexSetWithIndex:201]]];
    __block RKMappingResult *mappingResult = nil;
...
- (void)testManagerUsesResponseDescriptorForMethod
{
    ...
    RKResponseDescriptor *responseDescriptor1 = [RKResponseDescriptor responseDescriptorWithMapping:mapping1 method:RKHTTPMethodPOST pathPattern:@"/user" keyPath:nil statusCodes:RKStatusCodeIndexSetForClass(RKStatusCodeClassSuccessful)];
    RKResponseDescriptor *responseDescriptor2 = [RKResponseDescriptor responseDescriptorWithMapping:mapping2 method:RKHTTPMethodGET pathPattern:@"/user" keyPath:nil statusCodes:RKStatusCodeIndexSetForClass(RKStatusCodeClassSuccessful)];
    RKObjectManager *objectManager = [RKTestFactory objectManager];
    objectManager.requestSerializationMIMEType = RKMIMETypeJSON;
...
- (void)testThatRequestDescriptorExactMethodMatchFavoredOverRKHTTPMethodAny
{
    RKObjectMapping *mapping1 = [RKObjectMapping requestMapping];
    [mapping1 addAttributeMappingsFromArray:@[ @"name" ]];
    RKObjectMapping *mapping2 = [RKObjectMapping requestMapping];
    ...
    RKRequestDescriptor *requestDesriptor1 = [RKRequestDescriptor requestDescriptorWithMapping:mapping1 objectClass:[RKObjectMapperTestModel class] rootKeyPath:nil method:RKHTTPMethodAny];
    RKRequestDescriptor *requestDesriptor2 = [RKRequestDescriptor requestDescriptorWithMapping:mapping2 objectClass:[RKObjectMapperTestModel class] rootKeyPath:nil method:RKHTTPMethodPOST];
    RKObjectManager *objectManager = [RKTestFactory objectManager];
    objectManager.requestSerializationMIMEType = RKMIMETypeJSON;
    [objectManager addRequestDescriptor:requestDesriptor1];
    [objectManager addRequestDescriptor:requestDesriptor2];
...
- (void)testThatResponseDescriptorExactMethodMatchFavoredOverRKHTTPMethodAny
{
    RKObjectMapping *mapping1 = [RKObjectMapping mappingForClass:[RKTestUser class]];
    [mapping1 addAttributeMappingsFromArray:@[ @"name" ]];
    RKObjectMapping *mapping2 = [RKObjectMapping mappingForClass:[RKTestUser class]];
    ...
    RKResponseDescriptor *responseDescriptor2 = [RKResponseDescriptor responseDescriptorWithMapping:mapping2 method:RKHTTPMethodGET pathPattern:@"/user" keyPath:nil statusCodes:RKStatusCodeIndexSetForClass(RKStatusCodeClassSuccessful)];
    RKResponseDescriptor *responseDescriptor1 = [RKResponseDescriptor responseDescriptorWithMapping:mapping1 method:RKHTTPMethodAny pathPattern:@"/user" keyPath:nil statusCodes:RKStatusCodeIndexSetForClass(RKStatusCodeClassSuccessful)];
    RKObjectManager *objectManager = [RKTestFactory objectManager];
    objectManager.requestSerializationMIMEType = RKMIMETypeJSON;
    [objectManager addResponseDescriptorsFromArray:@[responseDescriptor1, responseDescriptor2]];
...
-(void)setUp{
    ...
    self.addressResponseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:addressMapping method:RKHTTPMethodGET pathPattern:@"address" keyPath:@"address" statusCodes:RKStatusCodeIndexSetForClass(RKStatusCodeClassSuccessful)];
    self.coordinateResponseDescriptor = [RKResponseDescriptor responseDescriptorWithMapping:coordinateMapping method:RKHTTPMethodPOST pathPattern:@"coordinate" keyPath:nil statusCodes:RKStatusCodeIndexSetForClass(RKStatusCodeClassSuccessful)];
 
    [self.objectManager.router.routeSet addRoute:[RKRoute routeWithClass:[RKTestCoordinate class] URITemplateString:@"coordinate" method:RKHTTPMethodPOST]];
...
-(void)testThatAppropriateObjectRequestOperationOnlyContainsResponseDescriptorsThatMatchObjectAndMethod{
    ...
    RKObjectRequestOperation *operation = [self.objectManager appropriateObjectRequestOperationWithObject:coordinate method:RKHTTPMethodPOST path:@"coordinate" parameters:nil];
...
-(void)testThatAppropriateObjectRequestOperationOnlyContainsResponseDescriptorsThatMatchPahtAndMethod{
    RKObjectRequestOperation *operation = [self.objectManager appropriateObjectRequestOperationWithObject:nil method:RKHTTPMethodGET path:@"address" parameters:nil];
    expect(operation.responseDescriptors.count).to.equal(1);
...
RKRequestDescriptor *RKRequestDescriptorFromArrayMatchingObjectAndRequestMethod(NSArray *requestDescriptors, id object, RKHTTPMethodOptions requestMethod);
...
- (void)setUp
{
    ...
    // Exact
    _exactClassAndExactMethodDescriptor = [RKRequestDescriptor requestDescriptorWithMapping:requestMapping objectClass:[RKSubclassedTestModel class] rootKeyPath:nil method:RKHTTPMethodPOST];
    _exactClassAndBitwiseMethodDescriptor = [RKRequestDescriptor requestDescriptorWithMapping:requestMapping objectClass:[RKSubclassedTestModel class] rootKeyPath:nil method:RKHTTPMethodPOST | RKHTTPMethodPUT];
    
    // Superclass
    _superclassAndExactMethodDescriptor = [RKRequestDescriptor requestDescriptorWithMapping:requestMapping objectClass:[RKObjectMapperTestModel class] rootKeyPath:@"superclass" method:RKHTTPMethodPOST];
    _superclassAndBitwiseMethodDescriptor = [RKRequestDescriptor requestDescriptorWithMapping:requestMapping objectClass:[RKObjectMapperTestModel class] rootKeyPath:@"superclass" method:RKHTTPMethodPOST | RKHTTPMethodPUT];
    
    // Non-matching
    _nonMatchingClassAndExactMethodDescriptor = [RKRequestDescriptor requestDescriptorWithMapping:requestMapping objectClass:[RKTestUser class] rootKeyPath:@"subclassed" method:RKHTTPMethodPOST];
}
...
{    
    ...
    RKRequestDescriptor *requestDescriptor = RKRequestDescriptorFromArrayMatchingObjectAndRequestMethod(descriptors, object, RKHTTPMethodPOST);
