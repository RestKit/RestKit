...
/**
 Sets the completion block to be invoked when the request generated by a page load finishes.
 
 @param success A block to be executed on success of the request. The block has no return value and takes three arguments: the paginator object, an array containing the paginated objects, and an integer indicating the page that was loaded.
 @param failure A block to be exected on failure of the request. The block has no return value and takes two arguments: the paginator object and an error indicating the nature of the failure.
 */
...
///-----------------------------------
/// @name Setting the Page Finished Block
///-----------------------------------
/**
 Sets the block to be invoked when the paginator finishes loading a page of results.
*/
