...
/**
 The data source for the `RKObjectMappingOperation` instances created by the operation to perform the mapping work.
...
/**
 The delegate for the `RKObjectMapperOperation` created by the receiver to perform object mapping on the deserialized response data. May be nil.
