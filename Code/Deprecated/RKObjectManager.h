...
/**
 ...
 These path patterns can then be registered with the manager via an `RKRoute` object (discussed in detail below), enabling one to perform object request operations like so:
    ...
    [manager.router.routeSet addRoute:[RKRoute routeWithClass:[RKArticle class] pathPattern:@"/categories/:comment.name/articles/:articleID/comments/" method:RKHTTPMethodGET]];
 ...
 To better understand these concepts, please consider the following example code for configuring the above routing examples:
    ...
    // Class Route
    [manager.router.routeSet addRoute:[RKRoute routeWithClass:[User class] pathPattern:@"/users/:userID" method:RKHTTPMethodGET]];
 
    // Relationship Route
    [manager.router.routeSet addRoute:[RKRoute routeWithRelationshipName:@"friends" objectClass:[User class] pathPattern:@"/users/:userID/friends" method:RKHTTPMethodGET]];
 
    // Named Route
    [manager.router.routeSet addRoute:[RKRoute routeWithName:@"follow_user" pathPattern:@"/users/:userID/follow" method:RKHTTPMethodPOST]];
...
/**
 ...
 @param method The HTTP method to match for the cancelled requests, such as `RKHTTPMethodGET`, `RKHTTPMethodPOST`, `RKHTTPMethodPUT`, `RKHTTPMethodPatch`, or `RKHTTPMethodDELETE`. If `RKHTTPMethodAny`, all object request operations with URLs matching the given path pattern will be cancelled. Multiple methods may be specified by using a bitwise OR operation.
...
/**
 ...
 @param method The HTTP method to match for the cancelled requests, such as `RKHTTPMethodGET`, `RKHTTPMethodPOST`, `RKHTTPMethodPUT`, `RKHTTPMethodPatch`, or `RKHTTPMethodDELETE`. If `RKHTTPMethodAny`, all object request operations with URLs matching the given path pattern will be cancelled.
 @param pathPattern The pattern to match against the path of the request URL for executing object request operations considered for cancellation.
