 ...
 */
#ifdef _COREDATADEFINES_H
static NSArray *RKFilteredArrayOfResponseDescriptorsMatchingPathAndMethod(NSArray *responseDescriptors, NSString *path, RKHTTPMethodOptions method)
{
...
- (NSURL *)URLWithRoute:(RKRoute *)route object:(id)object interpolatedParameters:(NSDictionary **)interpolatedParameters
{
    NSString *path = nil;
    if (object) {
        RKPathMatcher *pathMatcher = [RKPathMatcher pathMatcherWithPattern:route.URITemplate];
...
- (void)getObjectsAtPathForRelationship:(NSString *)relationshipName
                             ...
                             parameters:(NSDictionary *)parameters
                                ...
                                failure:(void (^)(RKObjectRequestOperation *operation, NSError *error))failure
{
    RKRoute *route = [self.router.routeSet routeForRelationship:relationshipName ofClass:[object class] method:RKHTTPMethodGET];
    NSDictionary *interpolatedParameters = nil;
    NSURL *URL = [self URLWithRoute:route object:object interpolatedParameters:&interpolatedParameters];
    NSAssert(URL, @"Failed to generate URL for relationship named '%@' for object: %@", relationshipName, object);
    RKObjectRequestOperation *operation = [self appropriateObjectRequestOperationWithObject:nil method:RKHTTPMethodGET path:[URL relativeString] parameters:parameters];
                              ...
                              failure:(void (^)(RKObjectRequestOperation *operation, NSError *error))failure
{
    ...
    NSURL *URL = [self URLWithRoute:route object:object interpolatedParameters:&interpolatedParameters];
    NSAssert(URL, @"No route found named '%@'", routeName);
    NSAssert(route.method & RKHTTPMethodGET, @"Expected route named '%@' to specify a GET, but it does not", routeName);
                 ...
                 failure:(void (^)(RKObjectRequestOperation *operation, NSError *error))failure
{
    ...
    RKObjectRequestOperation *operation = [self appropriateObjectRequestOperationWithObject:nil method:RKHTTPMethodGET path:path parameters:parameters];
    [operation setCompletionBlockWithSuccess:success failure:failure];
    [self enqueueObjectRequestOperation:operation];
}
          ...
          failure:(void (^)(RKObjectRequestOperation *operation, NSError *error))failure
{
    ...
    RKObjectRequestOperation *operation = [self appropriateObjectRequestOperationWithObject:object method:RKHTTPMethodGET path:path parameters:parameters];
    [operation setCompletionBlockWithSuccess:success failure:failure];
    [self enqueueObjectRequestOperation:operation];
}
...
{
    NSAssert(object || path, @"Cannot make a request without an object or a path.");
    RKObjectRequestOperation *operation = [self appropriateObjectRequestOperationWithObject:object method:RKHTTPMethodPOST path:path parameters:parameters];
    [operation setCompletionBlockWithSuccess:success failure:failure];
    [self enqueueObjectRequestOperation:operation];
}
...
{
    NSAssert(object || path, @"Cannot make a request without an object or a path.");
    RKObjectRequestOperation *operation = [self appropriateObjectRequestOperationWithObject:object method:RKHTTPMethodPUT path:path parameters:parameters];
    [operation setCompletionBlockWithSuccess:success failure:failure];
    [self enqueueObjectRequestOperation:operation];
}
...
{
    NSAssert(object || path, @"Cannot make a request without an object or a path.");
    RKObjectRequestOperation *operation = [self appropriateObjectRequestOperationWithObject:object method:RKHTTPMethodPATCH path:path parameters:parameters];
    [operation setCompletionBlockWithSuccess:success failure:failure];
    [self enqueueObjectRequestOperation:operation];
}
...
{
    NSAssert(object || path, @"Cannot make a request without an object or a path.");
    RKObjectRequestOperation *operation = [self appropriateObjectRequestOperationWithObject:object method:RKHTTPMethodDELETE path:path parameters:parameters];
    [operation setCompletionBlockWithSuccess:success failure:failure];
    [self enqueueObjectRequestOperation:operation];
}
...
- (NSArray *)enqueuedObjectRequestOperationsWithMethod:(RKHTTPMethodOptions)method matchingPathPattern:(NSString *)pathPattern
{
    ...
    for (NSOperation *operation in [self.operationQueue operations]) {
        ...
        RKHTTPMethodOptions operationMethod = RKHTTPMethodFromString([request HTTPMethod]);
...
- (void)cancelAllObjectRequestOperationsWithMethod:(RKHTTPMethodOptions)method matchingPathPattern:(NSString *)pathPattern
{
