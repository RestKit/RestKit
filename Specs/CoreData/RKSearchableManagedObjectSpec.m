//
//  RKSearchableManagedObjectSpec.m
//  RestKit
//
...
@interface RKSearchableManagedObjectSpec : RKSpec

@end

@implementation RKSearchableManagedObjectSpec

- (void)itShouldGenerateSearchWordsForSearchableObjects {
